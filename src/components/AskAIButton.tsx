        ...
        <Dialog open={open} onOpenChange={handleOnOpenChange}>
            ...
            <DialogContent className="custom-scrollbar flex h-[85vh] max-w-4xl flex-col overflow-y-auto" ref={contentRef}>
               <DialogHeader>
                  ...
                  <DialogDescription>
                     Our AI can answer questions about all fo your notes
                  </DialogDescription>
               </DialogHeader>
               ...
               <div className="mt-4 flex flex-col gap-8">
                 {
                    questions.map((questions, index) => (
                        <Fragment key={index}>
                            ...
                            {
                                responses[index] && (
                                    <p className="bot-response text-muted-foreground text-sm" dangerouslySetInnerHTML={{__html: responses[index]}} />
                                )
                            }
                        </Fragment>
                    ))
